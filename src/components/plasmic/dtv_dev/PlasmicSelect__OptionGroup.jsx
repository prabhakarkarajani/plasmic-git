...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: vYDHj97aG-Fr/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: psppkTLgzWJv/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__oyNx)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__yxlMf)}
              />
            </React.Fragment>
          ),
