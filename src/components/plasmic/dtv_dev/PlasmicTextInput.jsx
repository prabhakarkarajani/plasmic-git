...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: NGI8y2GcvmiY/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: MgfWpAaS6AI1/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__f66Bz)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__wb5FM)}
              role={"img"}
            />
          ),
